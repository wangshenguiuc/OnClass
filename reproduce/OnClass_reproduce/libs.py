...
datanames_26datasets = [DATA_DIR + '/Scanorama/data/293t_jurkat/293t',
DATA_DIR + '/Scanorama/data/293t_jurkat/jurkat',
DATA_DIR + '/Scanorama/data/293t_jurkat/jurkat_293t_50_50',
DATA_DIR + '/Scanorama/data/293t_jurkat/jurkat_293t_99_1',
DATA_DIR + '/Scanorama/data/brain/neuron_9k',
DATA_DIR + '/Scanorama/data/macrophage/infected',
DATA_DIR + '/Scanorama/data/macrophage/mixed_infected',
DATA_DIR + '/Scanorama/data/macrophage/uninfected',
DATA_DIR + '/Scanorama/data/macrophage/uninfected_donor2',
DATA_DIR + '/Scanorama/data/hsc/hsc_mars',
DATA_DIR + '/Scanorama/data/hsc/hsc_ss2',
DATA_DIR + '/Scanorama/data/pancreas/pancreas_inDrop',
DATA_DIR + '/Scanorama/data/pancreas/pancreas_multi_celseq2_expression_matrix',
DATA_DIR + '/Scanorama/data/pancreas/pancreas_multi_celseq_expression_matrix',
DATA_DIR + '/Scanorama/data/pancreas/pancreas_multi_fluidigmc1_expression_matrix',
DATA_DIR + '/Scanorama/data/pancreas/pancreas_multi_smartseq2_expression_matrix',
DATA_DIR + '/Scanorama/data/pbmc/10x/68k_pbmc',
DATA_DIR + '/Scanorama/data/pbmc/10x/b_cells',
DATA_DIR + '/Scanorama/data/pbmc/10x/cd14_monocytes',
DATA_DIR + '/Scanorama/data/pbmc/10x/cd4_t_helper',
DATA_DIR + '/Scanorama/data/pbmc/10x/cd56_nk',
DATA_DIR + '/Scanorama/data/pbmc/10x/cytotoxic_t',
DATA_DIR + '/Scanorama/data/pbmc/10x/memory_t',
DATA_DIR + '/Scanorama/data/pbmc/10x/regulatory_t',
DATA_DIR + '/Scanorama/data/pbmc/pbmc_kang',
DATA_DIR + '/Scanorama/data/pbmc/pbmc_10X']
